// Importez useState, useEffect, Text, View, StyleSheet, FlatList et TouchableOpacity
...
const MeteoCity = ({ navigation, route }) => {
  ...
  const renderItem = ({ item }) => (
    <View style={styles.previsionView} key={item.datetime}>
      ...
      <Icon name={mapWeatherIcon(item.weather)} size={30} color="#000" />
      <Text>
        ...
        <>
          <View style={styles.weatherContainer}>
            <View style={styles.headerContainer}>
              ...
              >
                <Text style={styles.toggleButtonText}>Toggle Unit</Text>
              </TouchableOpacity>
            </View>
            <View style={styles.weatherContainer}>
              <FlatList
